...
const Testimonial = () => {
    ...
    return (
      ...
      <section className="max-padd-container py-16 xl:px-22">
        <>
            <style>{`
        ...
        `}</style>
            ...
            <div className="marquee-row overflow-hidden relative">
                ...
                <div className="absolute right-0 top-0 h-full w-20 md:w-40 z-10 pointer-events-none bg-gradient-to-l from-white via-transparent
                 to-transparent"></div>
            </div>
        </>
        </section>
