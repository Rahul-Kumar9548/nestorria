    ...
    <section className='max-padd-container py-16 xl:py-22'>
            ...
            <div className='flex flex-col gap-y-12 xl:flex-row'>
                 ...
                 <div className='flex-1'>
                     ...
                     inline-block'>
                        <img src={assets.faq} alt="faqImg" className='block 
                        w-full'/>
                        <div className='absolute top-5 left-5 right-5
                        bg-white p-3 rounded-2xl flex items-center gap-4
                        z-10'>
                            <img src={assets.signature} alt="signImg"
                             width={55}/>
                             <div>
                                 <h5 className='bold-16'>Trusted Real Estate Experts</h5>
                                 <p>Trust, clarity, and simplicity are at the core of everything
                                   we do to make your property journey easy.</p>
                             </div>
                        </div>
                     </div>
                 </div>
                 ...
                 <div className='flex-1 flex flex-col justify-center'>
                      ...
                      />
                          ...
                          <div className='max-w-xl w-full flex flex-col
                           gap-4 items-start text-left'>
                          {faqsData.map((faq, index) => (
                            <div key={index} className='flex flex-col items-start w-full'>
                            <div className='flex items-center justify-between w-full cursor-pointer bg-secondary/10 border border-slate-900/10
                             p-2 px-4 rounded-lg' onClick={() => setOpenIndex(openIndex === index ? null : index)}>
