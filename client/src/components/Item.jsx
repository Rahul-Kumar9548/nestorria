...
const Item = ({property}) => {
  ...
  return (
        <Link to={'/listing/' + property._id}
         className='block rounded-lg bg-white ring-1 ring-slate-900'
        >
         {/* Image */}
            ...
            {/* info */}
             <div className='p-3'>
                  <div className='flexBetween'>
                      ...
                      <div className='bold-15 text-secondary'>{currency}{property.price.sale}
                      | ${property.price.rent}.00 <span className='text-xs'>/night
                        </span></div>
                  </div>
                  <h4 className='h4 line-clamp-1'>{property.title}</h4>
                   <div className="flexCenter gap-2 py-2">
                       ...
                       border-slate-900/50 pr-4 font-[500]'>
                           <img src={assets.bed} alt="facilitiesIcn"
                            width={21}/>
                       ...
                       <p className='flexCenter gap-x-2 border-r
                       border-slate-900/50 pr-4 font-[500]'>
                           <img src={assets.bath} alt="facilitiesIcn"
                            width={21}/>
                       ...
                       <p className='flexCenter gap-x-2 border-r
                       border-slate-900/50 pr-4 font-[500]'>
                           <img src={assets.car} alt="facilitiesIcn"
                            width={21}/>
                       ...
                       border-slate-900/50 pr-4 font-[500]'>
                           <img src={assets.ruler} alt="facilitiesIcn"
                            width={21}/>
