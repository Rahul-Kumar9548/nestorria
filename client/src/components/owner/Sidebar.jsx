  ...
  return (
    <div className='bg-gradient-to-r from-[#fffbee] to-white'>
         <div className='mx-auto max-w-[1440px] flex flex-col md:flex-row'>
              {/* Sidebar */}
              <div className='max-md:flexCenter flex flex-col justify-between bg-white
              sm:m-3 md:min-w-[20%] md:min-h-[90vh] rounded-xl shadow'>
                               ...
                               <div className='flex flex-1 p-3 lg:pl-8'>
                                ...
                                <div className='flex md:flex-col md:gap-x-5 gap-y-8 md:mt-4'>
                                     {navItems.map(link => (
                                         ...
                                         className={({isActive})=> isActive ? "flexStart gap-x-2 p-5 lg:pl-12 bold-13 sm:text-sm cursor-pointer h-10 bg-secondary/10 max-md:border-b-4 md:border-r-4 border-secondary" :
                                          "flexStart gap-x-2 lg:pl-12 p-5 bold-13 sm:text-sm cursor-pointer h-10 rounded-xl"}
                                         >
                                                <img src={link.icon} alt={link.label} 
                                                 className='hidden md:block' width={10}/>
                                                 <div>{link.label}</div>
                                         </NavLink>
                                     ))}
                                </div>
