                       ...
                       flex-col gap-4 h-full py-6 sm:pt-18 z-10'>
                            ...
                            <div className='flex flex-col mt-12 text-white'>
                                ...
                                rounded-full px-4 pr-0.5 py-1 cursor-pointer'>
                                 ...
                                 >Explore <span className='bg-gradient-to-r
                                 from-secondary to-white bg-clip-text
                               ...
                               px-6 py-4 flex flex-col lg:flex-row gap-4
                               lg:gap-x-8 max-w-md lg:max-w-full ring-1
                               ring-slate-900/5 relative'>
                                  <div className='flex flex-col w-full'>
                                      <div className='flex items-center gap-2'>
                                            <img src={assets.pin} alt="pinIcon" width={20}/>
                                            <label
                                             htmlFor="destinationInput">Destination</label> 
                                      </div>
                                         <input
                                         list='destinations'
                                         id='destinationInput' 
                                       ...
                                       <div className='flex flex-col w-full'>
                                         ...
                                         <div className='flex flex-col w-full'>
                                          ...
                                          gap-1 rounded-md bg-black py-3 px-6 text-white my-auto
                                          cursor-pointer max-md:w-full max-md:py-1'>
