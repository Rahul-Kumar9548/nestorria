            ...
            gap-12'>
                 ...
                 <div className='flex-1'>
                      ...
                      <div className='flex flex-col gap-6 mt-15'>
                         ...
                         {/* Rating */}
                         <div className='flex items-center divide-x divide-gray-200 mt-11'>
                              <div className='flex -space-x-3 pr-3'>
                                   ...
                                   <div className='pl-3'>
                                        <div className='flex items-center'>
                                              ...
                                              <img src={assets.star} alt="starIcon" width={17}/>
                                              <img src={assets.star} alt="starIcon" width={17}/>
                                              <p className='text-gray-600 medium-16 mt-2'>5.0</p>
                                        </div>
                                          <p className='text-sm text-gray-500'>
                                               Trusted by{" "}
                                               <span className='font-medium text-gray-600'>100,000+</span>{" "}
                                               users
                                          </p>
                                   </div>
                                </div>
