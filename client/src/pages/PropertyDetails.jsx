            ...
            <div className='bg-gradient-to-r from-[#fffbee] to-white py-16 pt-28'>
                <div className='max-padd-container'>
                    ...
                    <div className='flex flex-col xl:flex-row gap-8 mt-6'>
                        {/* Left Side */}
                        <div className='p-4 flex-2 rounded-xl border border-slate-500/10'>
                            ...
                            <div className='flex justify-between flex-col sm:flex-row sm:items-end mt-3'>
                               ...
                               <div className='flex justify-between items-start my-1'>
                                   <h4 className='h4 text-secondary'>{property.propertype}</h4>
                                   <div className='flex items-baseline gap-2 text-secondary relative top-1.5'>
                                       <h4 className='bold-18 relative bottom-0 text-black'>5.0</h4>
                                   ...
                                   <div className='flex gap-x-4'>
                                      <p className='flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]'>
                                        <img src={assets.bed} alt="" width={18}/>
                                        {property.facilities.bedrooms}
                                      </p>

                                      <p className='flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]'>
                                        <img src={assets.bath} alt="" width={18}/>
                                        {property.facilities.bathrooms}
                                      </p>

                                      <p className='flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]'>
                                        <img src={assets.car} alt="" width={18}/>
                                        {property.facilities.garages}
                                      </p>

                                      <p className='flexCenter gap-x-2 border-r border-slate-900/50 pr-4 font-[500]'>
                                        <img src={assets.ruler} alt="" width={18}/>
                                          400
                                      </p>
                                   </div>
                                    <div className='mt-6'>
                                    ...
                                    <div className='flex gap-3'>
                                     ...
                                     {/* Form Check Availability */}
                                        <form className='text-gray-500 bg-secondary/10 rounded-lg
                                        px-6 py-4 flex flex-col lg:flex-row gap-4 max-w-md lg:max-w-full ring-1
                                     ring-slate-900/5 relative mt-10'>
                                       ...
                                       <div className='flex flex-col w-full'>
                                           ...
                                           <label htmlFor="checkInDate">Check in</label>
                                             ...
                                             className='rounded bg-secondary/10 px-3
                                         ...
                                         <div className='flex flex-col w-full'>
                                          ...
                                          <div className='flex flex-col w-full'>
                                           ...
                                           <label htmlFor="guests">Guests</label>
                                             ...
                                             className='rounded bg-secondary/10 border border-gray-200 px-3
                                              py-1.5 mt-1.5 text-sm outline-none'
                                              placeholder='0'/>
                                       </div>
                                     ...
                                     <div className='flex-1 max-w-sm'>
                                          <div className='p-6 rounded-xl border border-slate-900/10'>
                                               ...
                                               <form className='flex flex-col gap-4'>
                                                     ...
                                                     <textarea rows={4} placeholder='Your Text' className='p-2 py-1 border border-gray-300 rounded-md text-sm' required/>
                                                     <button type='submit' className='btn-secondary rounded-lg py-1.5'>Send Message</button>
                                               </form>
                                               <h4 className="h4 mb-3 mt-8">For Buying Contect</h4>
                                                   <div className='text-sm w-80 divide-y divide-gray-500/30 border-gray-500/30 rounded'>
                                                       <div className='flex items-start justify-between p-3'>
                                                             <div>
                                                                  <div className='flex items-center space-x-2'>
                                                                      <h5 className='h5'>{property.agency.name}</h5>
                                                                      <p className='bg-green-500/20 py-0.5 rounded-full text-xs text-green-600 border
