              ...
              <div className='flex justify-between flex-wrap gap-2 sm:grid grid-cols-[2fr_2fr_1fr_1fr] lg:grid-cols-[0.5fr_2fr_2fr_1fr_1fr] px-6 py-3 bg-secondary
                ...
                <div>
                    {properties.map((property, index)=>(
                        ...
                        gap-2 sm:grid grid-cols-[2fr_2fr_1fr_1fr] lg:grid-cols-[0.5fr_2fr_2fr_1fr_1fr] px-6 py-3 bg-secondary/10 text-gray-50
                        medium-14 font-semibold border-b-2 border-slate-900/15'>
                             ...
                             <div>
                                 ...
                                 text-gray-900 gap-2'>
                                   <input type="checkbox" className='sr-only peer'
                                    defaultChecked={property.isAvailabel}
                                    />
                                    <div className='w-10 h-6 bg-slate-300 rounded-full peer
                                   peer-checked:bg-secondary transition-colors duration-200'/>
