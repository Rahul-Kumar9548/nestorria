...
const Dashboard = () => {
  ...
  return (
    ...
    bg-white shadow rounded-xl'>
          ...
          {/* Latest Bookings/Sales  */}
           <div className='mt-4'>
                <div className='flex justify-between flex-wrap gap-2 sm:grid grid-cols-[2fr_2fr_1fr_1fr] lg:grid-cols-[0.5fr_2fr_2fr_1fr_1fr] px-6 py-3 bg-secondary
                border-b-1 border-slate-900/15 rounded-t-xl'>
                  ...
                  {dashboardData.bookings.map((booking, index)=>(
                      ...
                      grid-cols-[2fr_2fr_1fr_1fr] lg:grid-cols-[0.5fr_2fr_2fr_1fr_1fr] px-6 py-3 bg-secondary/10 text-gray-50 medium-14
                      border-b-1 border-slate-900/15'>
                           ...
                           <div className='flexStart gap-x-2 max-w-64'>
                            ...
                            {new Date(booking.checkOutDate).toLocaleDateString()}</div>
                            <div>{currency}{booking.totalPrice}</div>
                            <button className={`${
                                booking.isPaid ? "bg-green-400/60 text-white" : "bg-secondary/10 text-red-500"
