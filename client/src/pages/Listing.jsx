  ...
  return (
    <div className="bg-gradient-to-r from-[#fffbee] to-white py-16 pt-28">
        <div className="max-padd-container flex flex-col sm:flex-row gap-8 mb-16">
            {/* Left-Side Filter */}
            <div className="bg-secondary/10 ring-1 ring-slate-900/50 p-4 sm:min-w-60 sm:h-[600px] rounded-xl">
                {/* sort by price */}
                <div className="py-3 mt-4">
                    <h5 className="h5 mb-3">Sort By</h5>
                    <select className="bg-secondary/10 border border-slate-900/10 outline-none text-gray-50 medium-14
                  ...
                  {/* property type */}
                   <div className="py-3 mt-4">
                    <h5 className="h5 mb-3">property By</h5>
